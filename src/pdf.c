...
/*   Updated: 2024/09/30 09:59:51 by lbrusa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * sphere_pdf_generate
	- Generates a random direction uniformly distributed over a sphere.
...
/**
 * hittable_pdf_generate
	- Generates a random direction using the PDF of the hittable objects.
 * @self: Pointer to the hittable_pdf structure.
 *
